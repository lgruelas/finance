...
def saves_old_expense_if_update(sender, instance, **kwargs):
    if is_admin_update(instance, **kwargs):
...
def increase_balance_on_income(sender, instance, created, **kwargs):
    if created:
        ...
        if instance.old_account_id:
            ...
            update_new_account_balance_from_income(instance, instance.amount)
        elif intance.old_amount:
            update_new_account_balance_from_income(instance, insntance.old_amount - instance.amount)
...
def decrease_balance_on_expense(sender, instance, created, **kwargs):
    if created and instance.is_payed:
        ...
        if instance.old_account_id:
            ...
            update_new_account_balance_from_expense(instance, insntance.old_amount -  instance.amount)
...
def update_balance_on_transfer(sender, instance, created, **kwargs):
    if created and instance.is_payed:
        ...
        if instance.old_account_id:
            update_old_account_balance_from_income(instance, instance.old_account_to_balance, instance.old_account_to_id)
            update_old_account_balance_from_expense(instance, instance.old_account_from_balance, intance.old_account_from_id)
            update_new_account_balance_from_income(instance, instance.amount, "account_to")
            update_new_account_balance_from_expense(instance, instance.amount, "account_from")
        elif intance.old_amount:
            update_new_account_balance_from_income(instance, insntance.old_amount -  instance.amount, "account_to")
            update_new_account_balance_from_expense(instance, insntance.old_amount -  instance.amount, "account_from")
